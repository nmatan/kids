...
export const CABO = {
  ...
  /* One short instruction per step. What to do now, not the rules again. */
  intro: 'המטרה: הסכום הנמוך ביותר.',
  lookAtThese: 'אלה שני הקלפים שלכם. תזכרו אותם.',
  doneLooking: '✓ סיימתי להציץ',
  yourTurn: 'התור שלכם.',
  drawHint: 'משכו מהחפיסה או קחו מהערמה',
  swapHint: 'לחצו על קלף שלכם כדי להחליף, או זרקו',
  drew: (v) => `משכתם ${v}.`,
  ...
  /* Powers live on their own button, so throwing away never surprises. */
  powerVerb: { 7: 'להציץ', 8: 'להחליף', 9: 'למשוך שניים' },
  usePower: (verb) => `✨ לזרוק ו${verb}`,
  powerPeek: 'בחרו קלף שלכם להציץ בו.',
  powerSwap: 'בחרו קלף שלכם להחלפה.',
  powerSwapCpu: 'עכשיו בחרו קלף של המחשב.',
  powerDrawTwo: 'בחרו איזה קלף לשמור.',
  ...
  cpuTookDiscard: (v) => `המחשב לקח ${v} מהערמה.`,
  cpuSwapped: 'המחשב החליף אחד מהקלפים שלו.',
  cpuThrew: (v) => `המחשב זרק ${v}.`,
  cpuPeeked: 'המחשב הציץ בקלף שלו.',
  cpuSwappedWithYou: 'המחשב החליף קלף אתכם.',
  cpuDrewTwo: 'המחשב משך שניים ושמר אחד.',

  call: '🐱 חתחתול!',
  youCalled: 'הכרזתם חתחתול. למחשב תור אחרון.',
  cpuCalled: 'המחשב הכריז חתחתול. לכם תור אחרון.',
  lastTurn: 'התור האחרון שלכם.',

  revealNow: 'חושפים!',
  /* The counting is the child's job — saying the totals would do it for him. */
  whoWon: 'עכשיו ספרו. מי ניצח?',
  guessMe: '🧒 אני',
  guessCpu: '🤖 המחשב',
  guessTie: '🤝 תיקו',
  countedRight: 'צדקתם!',
  countedWrong: 'בואו נספור שוב.',
