...
export const CABO = {
  ...
  /* One short instruction per step. The child needs to know what to do
     now, not the rules of the game again. */
  intro: 'המטרה: הסכום הנמוך ביותר.',
  lookAtThese: 'אלה שני הקלפים שלכם. תזכרו אותם!',
  peekDone: 'התור שלכם. משכו קלף.',
  yourTurn: 'התור שלכם. משכו קלף.',
  drew: (v) => `${v}. להחליף או לזרוק?`,
  chooseCard: 'בחרו קלף להחליף.',
  pickAnother: 'בחרו קלף אחר.',
  swapped: 'החלפתם.',
  threwAway: 'זרקתם.',
  throwAway: '🗑 לזרוק',

  // special powers — used when you throw the card away
  powers: { 7: 'הצץ', 8: 'החלף', 9: 'משוך שניים' },
  powerPeek: 'הצץ! בחרו קלף שלכם להציץ בו.',
  powerSwap: 'החלף! בחרו קלף שלכם.',
  powerSwapCpu: 'עכשיו בחרו קלף של המחשב.',
  powerDrawTwo: 'משכו שניים! בחרו איזה לשמור.',
  peeked: (v) => `${v}. תזכרו אותו.`,
  swappedWithCpu: 'החלפתם קלף עם המחשב.',

  // the "are you sure?" guard
  sureSwap: (mine, drawn) => `הקלף שלכם ${mine}, החדש ${drawn}. בטוחים?`,
  sureThrow: (v) => `${v} זה קלף טוב. בטוחים שזורקים?`,
  yesSure: 'כן',
  noBack: 'לא',

  cpuThinking: 'תור המחשב.',
  cpuDrew: 'המחשב משך קלף.',
  cpuTookDiscard: 'המחשב לקח מהערמה.',
  cpuSwapped: 'המחשב החליף קלף.',
  cpuThrew: 'המחשב זרק.',
  cpuPeeked: 'המחשב הציץ בקלף שלו.',
  cpuSwappedWithYou: 'המחשב החליף קלף אתכם!',
  cpuDrewTwo: 'המחשב משך שניים.',

  call: '🐱 חתחתול!',
  youCalled: 'חתחתול! למחשב תור אחרון.',
  cpuCalled: 'המחשב הכריז חתחתול! לכם תור אחרון.',
  lastTurn: 'התור האחרון שלכם.',

  revealNow: 'חושפים!',
  /* The counting is the child's job, not the app's — it flips the cards
     and then asks. Saying the totals aloud would do the work for him. */
  whoWon: 'עכשיו ספרו. מי ניצח?',
  guessMe: '🧒 אני',
  guessCpu: '🤖 המחשב',
  guessTie: '🤝 תיקו',
  countedRight: 'צדקתם!',
  countedWrong: 'בואו נספור שוב יחד.',
  totals: (mine, theirs) => `אתם ${mine}, המחשב ${theirs}`,
  youWon: (mine, theirs) => `${mine} מול ${theirs}. ניצחתם!`,
  cpuWon: (theirs, mine) => `${theirs} מול ${mine}. המחשב ניצח הפעם.`,
  tie: (n) => `תיקו! לשניכם ${n}.`,
  again: '↻ עוד משחק',
  leave: 'חזרה',
};
...
export const SET = {
  ...
  tryTitle: 'מצב בדיקה',
  tryHint: 'לשחק בכל משחק בכל רמה בלי שזה ייספר. לא צובר נקודות, לא מוריד מהמכסה היומית ולא נרשם בטבלה.',
  tryLevel: 'רמה',
  tryOpen: '▶ לשחק',
  ...
  caboPeekSeconds: 'שניות להצצה בקלף',
  caboPeekSecondsHint: 'כמה זמן קלף שהצצתם בו נשאר גלוי לפני שהוא מתהפך חזרה',
  caboShowPeeked: 'קלפים שהצצתם בהם נשארים גלויים',
  caboShowPeekedHint: 'כבוי — כמו בחתחתול האמיתי: מציצים לרגע וצריך לזכור. דלוק — הקלף נשאר גלוי, מה שמקל על ילדים קטנים.',
